...
export default function createMeet({address,isMOpen,onMClose})  {
  ...
  return(<div className="  overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none m-auto w-1/3 h-1/2 gap-3
   ...
   <div className="w-1/3 text-right"><button className="button1" onClick={()=>{register(img_url,username,address)}}>Submit</button></div>
 </div>)
